...
Run inside an environment with skrub, scikit-learn, pandas installed.
(stratum optional — if installed and STRATUM_RUST_BACKEND=1 is set in the
environment, the converted script's `import stratum as skrub` fallback
picks it up automatically; no harness changes needed either way.)
"""
import json
import os
import runpy
